...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private CardView expenseCardView, depositCardView, settingsCardView, aboutUsCardView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aboutUsCardView = findViewById(R.id.aboutUsCardViewId);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.expenseCardViewId){
            ...
            Toast.makeText(this, "Settings cardView is clicked.", Toast.LENGTH_SHORT).show();
        }
        else if (v.getId() == R.id.aboutUsCardViewId){
            Toast.makeText(this, "About us cardView is clicked.", Toast.LENGTH_SHORT).show();
        }
